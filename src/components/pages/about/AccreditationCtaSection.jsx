    ...
    <section className="relative overflow-hidden bg-slate-100/80 py-16 text-slate-700 md:py-24">
      ...
      <Container className="space-y-12 sm:space-y-16">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          {/* Card 1: Patients */}
          <div className="group relative min-h-80 overflow-hidden rounded-3xl bg-slate-900 shadow-xl ring-1 ring-slate-900/10 transition-all duration-500 hover:shadow-2xl sm:min-h-[360px]">
            {/* Background Image  */}
            <img
