...
export default function MissionVision() {
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-20 lg:px-8 overflow-hidden font-sans">
      {/* Background Glows */}
      <div className="pointer-events-none absolute -top-24 left-1/4 -z-10 h-96 w-96 rounded-full bg-[#0F2D2A]/5 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 right-1/4 -z-10 h-96 w-96 rounded-full bg-[#C68B45]/5 blur-3xl" />
      ...
      <div className="space-y-16 sm:space-y-24">
        ...
        <div className="group grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="lg:col-span-6">
            <div className="relative overflow-hidden rounded-3xl bg-white p-3 shadow-xl ring-1 ring-[#0F2D2A]/5">
          ...
          <div className="space-y-5 lg:col-span-6 lg:pl-2">
            <div className="inline-flex items-center gap-2 rounded-full bg-[#0F2D2A]/5 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#0F2D2A] ring-1 ring-[#0F2D2A]/10">
              <GlobeAltIcon className="h-4 w-4 text-[#C68B45]" />
              <span>Purpose & Core Values</span>
            </div>

            <h3 className="text-3xl font-extrabold tracking-tight text-[#0F2D2A] sm:text-4xl">
              OUR MISSION
            </h3>

            <p className="text-base leading-relaxed text-[#556061] sm:text-lg sm:leading-8">
            ...
            <p className="text-sm leading-relaxed text-[#556061]/80 sm:text-base">
            ...
            <div className="pt-2 space-y-2.5">
              {missionPoints.map((point, index) => (
                <div
                  key={index}
                  className="flex items-center text-sm font-semibold text-[#0F2D2A]"
                >
                  <CheckCircleIcon className="mr-2.5 h-5 w-5 shrink-0 text-[#C68B45]" />
                  <span>{point}</span>
                </div>
              ))}
            </div>
        ...
        <div className="group grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="order-2 space-y-5 lg:order-1 lg:col-span-6 lg:pr-2">
            <div className="inline-flex items-center gap-2 rounded-full bg-[#0F2D2A]/5 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#0F2D2A] ring-1 ring-[#0F2D2A]/10">
              <SparklesIcon className="h-4 w-4 text-[#C68B45]" />
