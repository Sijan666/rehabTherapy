      ...
      <section className="bg-white py-20 px-4 sm:px-6 lg:px-8 border-t border-[#EBEBEB]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="w-full sm:w-auto bg-[#0F2D2A] hover:bg-[#163A35] text-white font-semibold text-base px-8 py-3.5 rounded-lg transition-all duration-300 shadow-sm hover:shadow-md active:scale-95">
              Book an Assessment
            </button>
            <button className="w-full sm:w-auto bg-transparent border-2 border-[#C68B45] text-[#C68B45] hover:bg-[#C68B45] hover:text-white font-semibold text-base px-8 py-3.5 rounded-lg transition-all duration-300 shadow-sm hover:shadow-md active:scale-95">
              Request a Call Back
            </button>
          </div>
        </div>
