  ...
  return (
    <section className="bg-white py-20 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-[#556061] text-base md:text-lg max-w-2xl mx-auto mb-14 leading-relaxed font-normal">
          Recover faster and safer at home with structured rehab from our
          experienced therapists.
        </p>

        {/* Dynamic Card Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-14 justify-center">
          {services.map((item) => {
