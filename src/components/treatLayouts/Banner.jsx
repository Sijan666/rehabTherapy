      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 items-center gap-12">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="flex items-center gap-8 py-2">
            <div>
              <div className="font-serif text-3xl font-bold text-[#C68B45]">25+</div>
              <div className="text-[#B0C4C1] text-xs uppercase tracking-wider mt-0.5">Years Experience</div>
            </div>
            <div className="h-8 w-[1px] bg-white/10" />
            <div>
              <div className="font-serif text-3xl font-bold text-[#C68B45]">UK</div>
              <div className="text-[#B0C4C1] text-xs uppercase tracking-wider mt-0.5">Wide Coverage</div>
            </div>
          </div>
