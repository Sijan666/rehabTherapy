    ...
    <section className="relative min-h-[550px] bg-linear-to-br from-[#0F2D2A] via-[#163A35] to-[#0F2D2A] overflow-hidden flex items-center px-6 lg:px-16 py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 items-center gap-12">
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          {/* Primary CTA - High Contrast Pure White Pill Button */}
          <div className="pt-3">
            <button className="cursor-pointer inline-flex items-center justify-center bg-white hover:bg-white/90 text-[#0F2D2A] font-sans text-xs sm:text-sm font-bold tracking-widest uppercase px-8 py-4 rounded-full shadow-lg focus:outline-none focus:ring-2 focus:ring-[#C68B45]">
              Discover More
            </button>
          </div>
        </div>
