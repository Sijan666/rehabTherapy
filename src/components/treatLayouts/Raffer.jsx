      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        ...
        <div className="relative rounded-2xl overflow-hidden min-h-[280px] md:min-h-80 flex items-center justify-center shadow-md hover:shadow-xl transition-all duration-300 border border-[#0F2D2A]/10 group">
          ...
          <div className="relative z-10 p-6 sm:p-8 text-center flex flex-col items-center justify-center max-w-md">
            ...
            <button className="bg-[#C68B45] hover:bg-[#B37A38] text-white font-semibold text-base px-7 py-3 rounded-md transition-all duration-300 shadow-md hover:shadow-lg active:scale-95 border border-[#C68B45]/30 focus:outline-none">
              Get in Touch
            </button>
          </div>
        </div>
        ...
        <div className="relative rounded-2xl overflow-hidden min-h-[280px] md:min-h-80 flex items-center justify-center shadow-md hover:shadow-xl transition-all duration-300 border border-[#0F2D2A]/10 group">
          ...
          <div className="relative z-10 p-6 sm:p-8 text-center flex flex-col items-center justify-center max-w-md">
            ...
            <button className="bg-transparent hover:bg-[#C68B45] text-[#F8F7F2] hover:text-white font-semibold text-base px-7 py-3 rounded-md transition-all duration-300 border-2 border-[#C68B45] shadow-md hover:shadow-lg active:scale-95 focus:outline-none">
              Make a Referral
            </button>
          </div>
        </div>
