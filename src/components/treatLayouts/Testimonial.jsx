  ...
  return (
    <section className="bg-white py-20 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="lg:col-span-6 relative flex flex-col items-center">
            ...
            <div className="relative w-full bg-white rounded-2xl p-6 md:p-8 shadow-sm text-center border border-[#EBEBEB]">
              ...
              <button
                ...
                className="cursor-pointer absolute -left-3 top-1/2 -translate-y-1/2 bg-[#F2F4F4] hover:bg-[#0F2D2A] text-[#0F2D2A] hover:text-white p-2.5 rounded-full shadow-sm border border-[#EBEBEB] focus:outline-none"
              >
              ...
              <button
                ...
                className="cursor-pointer absolute -right-3 top-1/2 -translate-y-1/2 bg-[#F2F4F4] hover:bg-[#0F2D2A] text-[#0F2D2A] hover:text-white p-2.5 rounded-full shadow-sm border border-[#EBEBEB] focus:outline-none"
              >
        ...
        {/* Bottom CTA Button */}
        <div className="mt-14">
          <button className="cursor-pointer border-2 border-[#0F2D2A] text-[#0F2D2A] hover:bg-[#0F2D2A] hover:text-white font-semibold text-base px-8 py-3.5 rounded-lg shadow-sm hover:shadow-md">
            View More Reviews
          </button>
        </div>
      </div>
