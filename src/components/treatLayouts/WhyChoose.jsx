  ...
  return (
    <section className="bg-[#F8F7F2] py-16 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        {/* CTA Button */}
        <div>
          <button className="cursor-pointer bg-[#0F2D2A] hover:bg-[#112926] text-[#F8F7F2] font-semibold text-base md:text-lg px-8 py-3.5 rounded shadow-md hover:shadow-lg border border-[#C68B45]/30 focus:outline-none focus:ring-4 focus:ring-[#0F2D2A]/20">
            Book Home Visit Now
          </button>
        </div>
      </div>
